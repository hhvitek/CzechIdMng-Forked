...
@Tag(name = SysSyncItemLogController.TAG, description = "Single entity log")
public class SysSyncItemLogController
	...
	@Operation(
        ...
        operationId = "searchSyncItemLogs"
    )
	...
	@Operation(
			...
			operationId = "searchQuickSyncItemLogs",
