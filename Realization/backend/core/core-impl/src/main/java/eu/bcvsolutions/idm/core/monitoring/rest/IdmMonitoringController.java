...
public class IdmMonitoringController extends AbstractEventableDtoController<IdmMonitoringDto, IdmMonitoringFilter> {
	...
	public ResponseEntity<?> get(
			@Parameter(name = "Monitoring's uuid identifier or username.", required = true)
	...
	public Set<String> getPermissions(
			@Parameter(name = "Monitoring's uuid identifier.", required = true)
			@PathVariable @NotNull String backendId) {
	...
	public ResponseEntity<?> execute(
			@Parameter(name = "Monitoring codeable identifier.", required = true)
			@PathVariable @NotNull String backendId) {
